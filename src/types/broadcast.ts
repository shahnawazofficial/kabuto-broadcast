...
export type Round = 'Round 1' | 'Round 2' | 'Round 3' | 'Round 4' | 'Round 5' | string
export type Group = `Group ${number}` | string
export type BGMap = 'Erangel' | 'Miramar' | 'Sanhok' | 'Vikendi' | 'Rondo' | string
export type Match = 'Match 1' | 'Match 2' | 'Match 3' | 'Match 4' | 'Match 5' | 'Match 6' | string
...
export const GROUPS: Group[] = DEFAULT_GROUPS
export const MAPS: BGMap[] = ['Erangel', 'Miramar', 'Sanhok', 'Vikendi', 'Rondo']
